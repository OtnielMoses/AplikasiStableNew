...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> challenges = [
    {
      ...
      "description": "Bangun kekuatan dada, bahu, dan trisep dengan program push day terbaik.",
      "duration": "35 Min",
      "level": "Beginner",
      "gradientColors": [Color(0xFF1E3A5F), Color(0xFF1A5496), Color(0xFF2B7DE9)],
      "accentColor": Color(0xFF2B7DE9),
    },
    {
      "title": "Pull Day",
      "subtitle": "Back & Biceps",
      "description": "Perkuat otot punggung dan lengan dengan latihan pull yang intens.",
      "duration": "40 Min",
      "level": "Intermediate",
      "gradientColors": [Color(0xFF2D1B69), Color(0xFF4A2DB5), Color(0xFF6C5CE7)],
      "accentColor": Color(0xFF6C5CE7),
    },
    {
      "title": "Leg Day",
      "subtitle": "Lower Body",
      "description": "Bangun kekuatan kaki dan glutes dengan squat & deadlift intensif.",
      "duration": "45 Min",
      "level": "Advanced",
      "gradientColors": [Color(0xFF0A2E2E), Color(0xFF0F5050), Color(0xFF1D9E75)],
      "accentColor": Color(0xFF1D9E75),
    },
    {
      "title": "Full Body\nBlast",
      "subtitle": "Total Conditioning",
      "description": "Latihan seluruh tubuh yang komprehensif untuk kebugaran optimal.",
      "duration": "50 Min",
      "level": "Advanced",
      "gradientColors": [Color(0xFF2E1A0A), Color(0xFF7A3A10), Color(0xFFD4803A)],
      "accentColor": Color(0xFFD4803A),
    },
    {
      "title": "HIIT\nCardio",
      "subtitle": "Fat Burner",
      "description": "Bakar lemak maksimal dengan interval training intensitas tinggi.",
      "duration": "25 Min",
      "level": "Intermediate",
      "gradientColors": [Color(0xFF3A0A0A), Color(0xFF8B2200), Color(0xFFD85A30)],
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              const Text("Set Timer", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
              Expanded(
  ...
  void _startWorkout(WorkoutDay workout) {
    if (!_isTimerSet || (_timerMinutes == 0 && _timerSeconds == 0)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please set timer first"), backgroundColor: Color(0xFFFF453A)),
      );
      return;
    }
    Navigator.push(
  ...
  void _showChatDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text("Chat Support", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        content: TextField(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Message sent. We'll respond soon."), backgroundColor: Color(0xFF34C759)),
              );
            },
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFD4FF33), foregroundColor: Colors.black, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            _buildCardChip(duration, Colors.white.withOpacity(0.15), Colors.white.withOpacity(0.9), border: Colors.white.withOpacity(0.2)),
                            const SizedBox(width: 8),
                            _buildCardChip(level.toUpperCase(), accentColor.withOpacity(0.2), const Color(0xFFD4FF33), border: const Color(0xFFD4FF33).withOpacity(0.4)),
                          ],
                        ),
                        const Spacer(),
                        Text(title, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Colors.white, height: 0.95, letterSpacing: 0.5)),
                        const SizedBox(height: 10),
                        Text(description, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.75), height: 1.4)),
                        const SizedBox(height: 16),
  ...
  Widget _buildCardChip(String text, Color bg, Color textColor, {required Color border}) {
    return Container(
      ...
      child: Text(text, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: textColor, letterSpacing: 0.5)),
    );
  }
  ...
  Widget _buildComplaintSection() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Center(child: Text("Tidak menemukan latihan mu? Chat Admin", style: TextStyle(fontSize: 13, color: Color(0xFFD4FF33)))),
      ),
    );
  }
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isSelected ? Colors.transparent : const Color(0xFF2A2D35)),
              ),
              child: Center(child: Text(level, style: TextStyle(color: isSelected ? Colors.black : const Color(0xFF8E8E93), fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400, fontSize: 14))),
            ),
          );
        },
      ),
  ...
  Widget _buildTodayActivitySection() {
    if (_isLoadingWorkout) {
      return Container(
        height: 160,
        decoration: BoxDecoration(color: const Color(0xFF1A1C24), borderRadius: BorderRadius.circular(20)),
        child: const Center(child: CircularProgressIndicator(color: Color(0xFFD4FF33))),
      );
    }
  ...
  Widget _buildHeader() {
    return Row(
      children: [
        Container(
          width: 52, height: 52,
          decoration: const BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: [Color(0xFFD4FF33), Color(0xFFA8CC29)])),
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(_userName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
              const Text("Have a productive workout day!", style: TextStyle(fontSize: 13, color: Color(0xFF8E8E93))),
            ],
          ),
        ),
        GestureDetector(
          ...
          child: Container(
            ...
            child: const Icon(Icons.chat_bubble_outline, size: 22, color: Color(0xFFD4FF33)),
          ),
        ),
      ],
    );
  ...
  Widget _buildDateSection(String dayName, String formattedDate) {
    return Center(
      child: Column(
        children: [
          Text(dayName.toUpperCase(), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFFD4FF33), letterSpacing: 1)),
          const SizedBox(height: 6),
          Text(formattedDate, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Colors.white)),
        ],
      ),
    );
  }
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: isSelected ? const Color(0xFFD4FF33) : const Color(0xFF1A1C24),
                ),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(DateFormat('E').format(date), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: isSelected ? Colors.black : const Color(0xFF8E8E93))),
                    const SizedBox(height: 6),
  ...
  Widget _buildTodayWorkoutCard(WorkoutDay workout) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [Color(0xFF1A1C24), Color(0xFF23262F)]),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: const Color(0xFFD4FF33).withOpacity(0.3)),
      ),
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(10),
                decoration: BoxDecoration(color: const Color(0xFFD4FF33).withOpacity(0.15), borderRadius: BorderRadius.circular(12)),
                child: const Icon(Icons.fitness_center, color: Color(0xFFD4FF33), size: 24),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(workout.sectionName, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                    const SizedBox(height: 4),
                    Text("${workout.exercises.length} exercises", style: const TextStyle(fontSize: 13, color: Color(0xFF8E8E93))),
                  ],
                ),
              ),
            ],
          ...
          Wrap(
            ...
            children: workout.bodyParts.map((part) => Container(
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
              decoration: BoxDecoration(color: const Color(0xFF2A2D35), borderRadius: BorderRadius.circular(8)),
              child: Text(part, style: const TextStyle(fontSize: 11, color: Color(0xFFD4FF33))),
            )).toList(),
          ),
          const SizedBox(height: 14),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          const Text("No workout planned for today", style: TextStyle(fontSize: 15, color: Color(0xFF8E8E93))),
          const SizedBox(height: 12),
          ElevatedButton(
            onPressed: widget.onCreateWorkout,
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFD4FF33), foregroundColor: Colors.black, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
            child: const Text("Create Plan", style: TextStyle(fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
  ...
  Widget _buildTimerCard() {
    return Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), boxShadow: [BoxShadow(color: const Color(0xFFD4FF33).withOpacity(0.2), blurRadius: 12, spreadRadius: 2)]),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(20),
        child: Stack(
          children: [
            Image.asset('assets/time.jpg', height: 120, width: double.infinity, fit: BoxFit.cover),
            Container(height: 120, decoration: BoxDecoration(color: const Color(0xFF6C5CE7).withOpacity(0.85))),
            Padding(
              padding: const EdgeInsets.all(20),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Column(
                    ...
                    children: [
                      const Text("WORKOUT TIMER", style: TextStyle(color: Color(0xFFD4FF33), fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1)),
                      const SizedBox(height: 4),
                      Text(_isTimerSet ? "${(_timerMinutes ~/ 60).toString().padLeft(2, '0')}:${(_timerMinutes % 60).toString().padLeft(2, '0')}" : "00:00", style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
                    ],
                  ),
                  OutlinedButton(
                    onPressed: _showTimerPicker,
                    style: OutlinedButton.styleFrom(foregroundColor: Colors.white, side: const BorderSide(color: Color(0xFFD4FF33), width: 1.5), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(40))),
  ...
  Widget _buildCreateWorkoutButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: widget.onCreateWorkout,
        style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFD4FF33), foregroundColor: Colors.black, padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
        child: const Text("Create Workout", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
      ),
    );
  }
  ...
  Widget _buildWorkoutCard(Map<String, String> workout) {
    ...
    final levelColor = level == "Beginner" ? const Color(0xFF4A90E2) : level == "Intermediate" ? const Color(0xFF6C5CE7) : const Color(0xFFFF453A);
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(workout["title"]!, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: 0.5)),
                  const SizedBox(height: 10),
                  Row(
                    children: [
  ...
  Widget _buildSportyIcon(IconData icon, String text, Color color) {
    return Row(children: [Icon(icon, size: 14, color: color), const SizedBox(width: 6), Text(text, style: const TextStyle(fontSize: 12, color: Colors.white70))]);
  }
  ...
  Widget _buildStartButton(VoidCallback onPressed) {
    return SizedBox(
      ...
      child: OutlinedButton(
        onPressed: onPressed,
        style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFFD4FF33), side: const BorderSide(color: Color(0xFFD4FF33)), padding: const EdgeInsets.symmetric(vertical: 10), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
...
class _CardGeoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final linePaint = Paint()..color = const Color(0xFFD4FF33).withOpacity(0.15)..strokeWidth = 2.0..strokeCap = StrokeCap.round;
    canvas.drawLine(Offset(w * 0.60, h * 0.08), Offset(w * 0.82, h * 0.02), linePaint);
    final linePaint2 = Paint()..color = const Color(0xFFD4FF33).withOpacity(0.08)..strokeWidth = 1.5..strokeCap = StrokeCap.round;
